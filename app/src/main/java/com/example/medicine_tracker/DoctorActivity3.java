...
public class DoctorActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date_format.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog=new DatePickerDialog(
                        DoctorActivity3.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.with(DoctorActivity3.this)
    ...
    private void saveDataToDatabase() {
        ...
        int d_id=Integer.parseInt(doc_id.getText().toString());
        ...
        System.out.println(doctor.getDoc_name());
        System.out.println(doctor.getFirst_date());
        System.out.println(doctor.getMeet_date());


            long row_id=myDatabaseHelper.update_doc_data(doctor);
            ...
            if(row_id==-1){
                ...
                Toast.makeText(getApplicationContext(),"Row"+row_id+"Row is successfully updated",Toast.LENGTH_LONG).show();
                openDoctorActivity2();
            }
